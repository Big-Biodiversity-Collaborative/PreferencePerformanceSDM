...
#' Based on function from https://github.com/Big-Biodiversity-Collaborative/SwallowtailClimateChange
#' 
#' @return NULL
download_gbif <- function(species_name, gbif_name, replace = FALSE, 
                          verbose = FALSE, countries = c("CA", "MX", "US"),
                          destination_dir = "data/gbif",
  ...
  nice_name <- tolower(x = gsub(pattern = " ",
                                replacement = "_",
                                x = species_name))
  filename <- paste0(destination_dir, "/", nice_name, "-gbif-raw.csv")
